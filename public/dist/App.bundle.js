...
function cartUpdate(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    _this.buy.classList.add('disabled');
...
function followUser(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    (0, _bling.$)('.followers-count').textContent = res.data.followers.length + ' Followers';
  }).catch(console.error);
}
...
var _removecart = __webpack_require__(12);
...
var _viewmore = __webpack_require__(13);

var _viewmore2 = _interopRequireDefault(_viewmore);
...
var viewExpand = (0, _bling.$$)('.more-predictions');
